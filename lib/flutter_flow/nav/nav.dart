...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'TelegramPage',
          path: '/telegramPage',
          builder: (context, params) => TelegramPageWidget(),
        ),
        FFRoute(
          name: 'NewsDetail',
          path: '/newsDetail',
          builder: (context, params) => NewsDetailWidget(
            ...
            newsDescription: params.getParam(
              'newsDescription',
              ParamType.String,
            ),
            newsImage: params.getParam(
              'newsImage',
              ParamType.String,
            ),
            newsPublishedAt: params.getParam(
              'newsPublishedAt',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          path: '/liveStreamPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'LiveStreamPage')
              : LiveStreamPageWidget(),
        ),
        FFRoute(
          name: 'SocialPageDup',
          path: '/socialPageDup',
          builder: (context, params) => SocialPageDupWidget(),
        ),
        FFRoute(
          name: 'MediaPage',
          path: '/mediaPage',
        ...
        FFRoute(
          ...
          path: '/successfulCreatePost',
          builder: (context, params) => SuccessfulCreatePostWidget(),
        ),
        FFRoute(
          name: 'SocialPage',
          path: '/socialPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SocialPage')
              : SocialPageWidget(),
        ),
        FFRoute(
          name: 'EditProfileRefine',
          path: '/editProfileRefine',
          builder: (context, params) => EditProfileRefineWidget(),
        ),
        FFRoute(
          name: 'PhoneAuthPage',
          path: '/phoneAuthPage',
        ...
        FFRoute(
          name: 'LiveStreamPageRefine',
          path: '/liveStreamPageRefine',
          builder: (context, params) => LiveStreamPageRefineWidget(),
        )
