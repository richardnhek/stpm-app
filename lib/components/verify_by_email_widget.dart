...
import 'verify_by_email_model.dart';
export 'verify_by_email_model.dart';

class VerifyByEmailWidget extends StatefulWidget {
  const VerifyByEmailWidget({super.key});

  @override
  State<VerifyByEmailWidget> createState() => _VerifyByEmailWidgetState();
}

class _VerifyByEmailWidgetState extends State<VerifyByEmailWidget>
    with TickerProviderStateMixin {
  late VerifyByEmailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyByEmailModel());
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.isVerified =
                                          await actions.emailOTPVerification(
                                        currentUserEmail,
