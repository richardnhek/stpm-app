            ...
            children: [
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final rowSTPMEventsResponse = snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final relatedFeeds = getJsonField(
                                  rowSTPMEventsResponse.jsonBody,
                                  r'''$.data''',
                                ).toList();
                                ...
                                return SingleChildScrollView(
                                  ...
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: List.generate(relatedFeeds.length,
                                        (relatedFeedsIndex) {
                                      final relatedFeedsItem =
                                          relatedFeeds[relatedFeedsIndex];
                                      return ClipRRect(
                                        borderRadius:
                                        ...
                                        child: Image.network(
                                          'https://1.demo.hunmanet.kh/${getJsonField(
                                            relatedFeedsItem,
                                            r'''$.attributes.thumbnail.data[0].attributes.formats.large.url''',
                                          ).toString()}',
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    await launchURL(
                        'https://stpm.hunmanet.kh/${FFLocalizations.of(context).languageCode == 'en' ? 'en/' : ''}${() {
                      if (widget!.newsType == 'Feed') {
                        return 'feed';
                      } else if (widget!.newsType == 'Event') {
                        return 'event_page';
                      } else {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [Color(0xCB253A95), Color(0xCCE31E2C)],
                        stops: [0.0, 1.0],
