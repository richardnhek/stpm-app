...
import 'live_stream_page_refine_model.dart';
export 'live_stream_page_refine_model.dart';

class LiveStreamPageRefineWidget extends StatefulWidget {
  const LiveStreamPageRefineWidget({super.key});

  @override
  State<LiveStreamPageRefineWidget> createState() =>
      _LiveStreamPageRefineWidgetState();
}

class _LiveStreamPageRefineWidgetState
    extends State<LiveStreamPageRefineWidget> {
  late LiveStreamPageRefineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LiveStreamPageRefineModel());
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: FFAppState().liveStreamVideoQuery(
                        requestFn: () =>
                            STPMAPICallGroupGroup.sTPMGetSiteConfigCall.call(
