                                                            ...
                                                            children: [
                                                              ClipRRect(
                                                                ...
                                                                child:
                                                                  ...
                                                                  imageUrl:
                                                                      'https://1.demo.hunmanet.kh${() {
                                                                    if (feedDataItem.attributes.thumbnail.data.first.attributes.formats.large.url !=
                                                                            null &&
                                                                        feedDataItem.attributes.thumbnail.data.first.attributes.formats.large.url !=
                                                                            '') {
                                                                      return feedDataItem
                                                                          .attributes
                                                                          .thumbnail
                                                                          ...
                                                                          .large
                                                                          .url;
                                                                    } else if (feedDataItem.attributes.thumbnail.data.first.attributes.formats.medium.url !=
                                                                            null &&
                                                                        feedDataItem.attributes.thumbnail.data.first.attributes.formats.medium.url !=
                                                                            '') {
                                                                      return (feedDataItem.attributes.thumbnail.data.first.attributes.formats.medium.url != null &&
                                                                              feedDataItem.attributes.thumbnail.data.first.attributes.formats.medium.url != '')
                                                                          .toString();
                                                                    } else {
                                                                      return feedDataItem
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                                Text(
                                                                              feedDataItem.attributes.description,
                                                                              textAlign: TextAlign.start,
                                                                              maxLines: 2,
                                                                              style: FlutterFlowTheme.of(context).displaySmall.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).displaySmallFamily,
